...
const TRANSLATIONS = {
  en: {
    ...
    tutorialStalemateCaption: 'Below: Green’s only piece is boxed in on every side, and its one possible jump is blocked too — no legal move means Green loses right here.',
    tutorialHouseRuleNote: 'House rule: in this digital version, capturing is always optional — even mid-chain, you may stop after any hop. Traditional physical play often makes capturing mandatory; we chose the gentler variant for a smoother first game.',
    tutorialRecapTitle: 'You’re Ready!',
    tutorialRecapBody: 'Setup, movement, capturing, chain captures, winning — that’s the whole game. Jump into a real match whenever you like.',
    tutorialPlayLocal: 'Play Local Now',
    tutorialPlayAI: 'Play vs AI Now',
    tutorialStepOf: 'Step {n} of {total}',
    tutorialDrillDone: 'Well done!',
    tutorialPrev: '← Back',
    tutorialNext: 'Next →',
    legendCanCapture: 'Pulsing gold ring: this piece can capture',
    legendLegalDest: 'Dashed gold circle: a legal destination',
    legendSelected: 'Bright ring: your selected piece',
    resetPractice: 'Reset',
  ...
  bn: {
    ...
    tutorialStalemateCaption: 'নিচে: সবুজের একমাত্র গুটিটি চারদিক থেকে ঘেরাও হয়ে আছে, এবং তার একমাত্র সম্ভাব্য লাফও আটকানো — কোনো বৈধ চাল নেই মানেই সবুজ এখানেই হেরে যাবে।',
    tutorialHouseRuleNote: 'ঘরোয়া নিয়ম: এই ডিজিটাল সংস্করণে গুটি ধরা সবসময় ঐচ্ছিক — পরপর ধরার মাঝেও যেকোনো ধাপের পর থামতে পারেন। ঐতিহ্যবাহী মাঠের খেলায় প্রায়ই গুটি ধরা বাধ্যতামূলক হয়; আমরা প্রথমবারের খেলাকে সহজ করতে এই নমনীয় নিয়মটি বেছে নিয়েছি।',
    tutorialRecapTitle: 'আপনি প্রস্তুত!',
    tutorialRecapBody: 'প্রস্তুতি, চাল দেওয়া, গুটি ধরা, পরপর ধরা, জয় — এটাই পুরো খেলা। যখন ইচ্ছা একটি আসল খেলায় নেমে পড়ুন।',
    tutorialPlayLocal: 'স্থানীয় খেলা শুরু করুন',
    tutorialPlayAI: 'কম্পিউটারের সাথে খেলুন',
    tutorialStepOf: 'ধাপ {n} / {total}',
    tutorialDrillDone: 'চমৎকার!',
    tutorialPrev: '← পেছনে',
    tutorialNext: 'পরবর্তী →',
    legendCanCapture: 'স্পন্দিত সোনালি বলয়: এই গুটি ধরতে পারে',
    legendLegalDest: 'ড্যাশ করা সোনালি বৃত্ত: একটি বৈধ গন্তব্য',
    legendSelected: 'উজ্জ্বল বলয়: আপনার নির্বাচিত গুটি',
    resetPractice: 'রিসেট',
  ...
  ko: {
    ...
    tutorialStalemateCaption: '아래: 초록의 유일한 말이 사방으로 둘러싸여 있고, 유일하게 가능한 점프도 막혀 있습니다 — 둘 수 있는 수가 없으면 초록은 바로 이 자리에서 패배합니다.',
    tutorialHouseRuleNote: '하우스 룰: 이 디지털 버전에서는 잡기가 항상 선택 사항입니다 — 연속 잡기 도중에도 언제든 멈출 수 있습니다. 전통적인 실물 대전에서는 잡기가 의무인 경우가 많지만, 첫 게임을 더 부드럽게 만들기 위해 이 완화된 규칙을 선택했습니다.',
    tutorialRecapTitle: '준비 완료!',
    tutorialRecapBody: '배치, 이동, 잡기, 연속 잡기, 승리 — 이것이 게임의 전부입니다. 언제든 실전 대전을 시작해보세요.',
    tutorialPlayLocal: '로컬 대전 시작',
    tutorialPlayAI: 'AI와 바로 대전',
    tutorialStepOf: '{n} / {total} 단계',
    tutorialDrillDone: '잘했어요!',
    tutorialPrev: '← 이전',
    tutorialNext: '다음 →',
    legendCanCapture: '깜빡이는 금색 테두리: 이 말은 잡을 수 있습니다',
    legendLegalDest: '점선 금색 원: 이동 가능한 위치',
    legendSelected: '밝은 테두리: 선택한 말',
    resetPractice: '초기화',
